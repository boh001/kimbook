...
eval("var actionLike = document.getElementsByClassName(\"jsCommentLike\");\nvar comment = document.getElementsByClassName(\"jsReComment\");\nvar commentShow = document.getElementsByClassName(\"jsCommentShow\");\nvar reCommentShow = document.getElementsByClassName(\"jsReCommentShow\");\n\nvar upLike = function upLike(id, like) {\n  fetch(\"/api/\".concat(id, \"/commentLike\"), {\n    method: \"POST\",\n    headers: {\n      \"Content-Type\": \"application/json\"\n    },\n    body: JSON.stringify({\n      id: id\n    })\n  }).then(function (res) {\n    return res.json();\n  }).then(function (myJson) {\n    like.innerText = parseInt(like.innerText) + myJson.body;\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n};\n\nvar upComment = function upComment(id, text) {\n  fetch(\"/api/\".concat(id, \"/reComment\"), {\n    method: \"POST\",\n    headers: {\n      \"Content-Type\": \"application/json\"\n    },\n    body: JSON.stringify({\n      id: id,\n      text: text\n    })\n  }).then(function (res) {\n    return res.json();\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n};\n\nvar handleReactLike = function handleReactLike(event) {\n  event.preventDefault();\n  var target = event.currentTarget;\n  var like = target.nextSibling.firstChild;\n  var commentId = target.parentNode.parentNode.id;\n  upLike(commentId, like);\n};\n\nvar handleComment = function handleComment(event) {\n  if (event.keyCode === 13) {\n    event.preventDefault();\n    var target = event.currentTarget;\n    var text = target.value;\n    var homeCommentId = target.parentNode.parentNode.parentNode.id;\n    upComment(homeCommentId, text);\n    target.value = \"\";\n  }\n};\n\nvar handleCommentShow = function handleCommentShow(event) {\n  event.preventDefault();\n  var target = event.currentTarget;\n  target.parentNode.nextSibling.style.display = \"flex\";\n};\n\nvar handleReCommentShow = function handleReCommentShow(event) {\n  event.preventDefault();\n  var target = event.currentTarget;\n  console.log(target);\n  var nickname = target.parentNode.previousSibling.lastChild.firstChild;\n  var input = target.parentNode.parentNode.parentNode.previousSibling.lastChild;\n  console.log(nickname);\n  input.style.color = \"#4267b2\";\n  input.value = \"\".concat(nickname.innerHTML, \"  \");\n};\n\nvar init = function init() {\n  var actionList = Array.from(actionLike);\n  var commentList = Array.from(comment);\n  var commentShowList = Array.from(commentShow);\n  var reCommentShowList = Array.from(reCommentShow);\n  actionList.forEach(function (a) {\n    return a.addEventListener(\"click\", handleReactLike);\n  });\n  commentList.forEach(function (c) {\n    return c.addEventListener(\"keyup\", handleComment);\n  });\n  commentShowList.forEach(function (s) {\n    return s.addEventListener(\"click\", handleCommentShow);\n  });\n  reCommentShowList.forEach(function (r) {\n    return r.addEventListener(\"click\", handleReCommentShow);\n  });\n};\n\nif (actionLike) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/commentReact.js?");
...
eval("var actionLike = document.getElementsByClassName(\"jsContentLike\");\nvar video = document.getElementsByTagName(\"video\");\nvar comment = document.getElementsByClassName(\"jsComment\");\nvar reply = document.getElementsByClassName(\"jsShowReply \");\n\nvar upLike = function upLike(id, like) {\n  fetch(\"/api/\".concat(id, \"/like\"), {\n    method: \"POST\",\n    headers: {\n      \"Content-Type\": \"application/json\"\n    },\n    body: JSON.stringify({\n      id: id\n    })\n  }).then(function (res) {\n    return res.json();\n  }).then(function (myJson) {\n    like.innerText = parseInt(like.innerText) + myJson.body;\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n};\n\nvar upView = function upView(id, view) {\n  fetch(\"/api/\".concat(id, \"/view\"), {\n    method: \"POST\",\n    headers: {\n      \"Content-Type\": \"application/json\"\n    },\n    body: JSON.stringify({\n      id: id\n    })\n  }).then(function (res) {\n    return res.json();\n  }).then(function (myJson) {\n    view.innerText = parseInt(view.innerText) + myJson.body;\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n};\n\nvar upComment = function upComment(id, text, ul, reply) {\n  fetch(\"/api/\".concat(id, \"/comment\"), {\n    method: \"POST\",\n    headers: {\n      \"Content-Type\": \"application/json\"\n    },\n    body: JSON.stringify({\n      id: id,\n      text: text\n    })\n  }).then(function (res) {\n    return res.json();\n  }).then(function (myJson) {\n    var body = myJson.body;\n    var _body$author = body.author,\n        avatarUrl = _body$author.avatarUrl,\n        nickname = _body$author.nickname;\n    var replyCount = body.reply;\n    reply.innerText = replyCount;\n    var div = document.createElement(\"div\");\n    div.className = \"comment__list\";\n    div.id = body.id;\n    div.innerHTML = \"\\n      <div class=\\\"list__list\\\">\\n        <img class=\\\"miniAvatar2\\\" src=\\\"/\".concat(avatarUrl, \"\\\"/>\\n        <div class=\\\"list__description\\\">\\n          <span class=\\\"description__name\\\">\").concat(nickname, \"</span>\\n          <span class=\\\"description__list\\\">\").concat(text, \"</span>      \\n        </div>\\n      </div>\\n      <div class=\\\"list__react\\\">\\n        <div class=\\\"comment__like jsCommentLike\\\">\\n          \\uC88B\\uC544\\uC694\\n        </div>\\n        <div class=\\\"comment__infoLike\\\">\\n          <span class=\\\"infoLike__count\\\">0</span>\\n          <span class=\\\"infoLike__sub\\\">\\uAC1C</span>\\n        </div>\\n        <div class=\\\"comment__show jsCommentShow\\\">\\uB313\\uAE00\\uBCF4\\uAE30\\n        </div>\\n      </div>\\n      <div class=\\\"comment__reComments\\\" style=\\\"display:flex\\\">\\n        <div class=\\\"reComments__user\\\">\\n          <img class=\\\"miniAvatar2\\\" src= \\\"/\").concat(avatarUrl, \"\\\"/>\\n          <input class=\\\"user__text jsRecomment\\\" type=\\\"text\\\" name=\\\"comment\\\" placeholder=\\\"please write comments\\\">\\n        </div>\\n        <div class=\\\"reComments__lists\\\">\\n        </div>\\n      </div>\");\n    ul.appendChild(div);\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n};\n\nvar handleReactLike = function handleReactLike(event) {\n  event.preventDefault();\n  var target = event.currentTarget;\n  var homeReactLike = target.parentNode.previousSibling.children[0].lastChild;\n  var homeContentId = target.parentNode.parentNode.id;\n  upLike(homeContentId, homeReactLike);\n};\n\nvar handleView = function handleView(event) {\n  event.preventDefault();\n  var target = event.currentTarget;\n  var homeContentId = target.parentNode.id;\n  var reactView = target.nextSibling.children[1].lastChild;\n  upView(homeContentId, reactView);\n};\n\nvar handleComment = function handleComment(event) {\n  if (event.keyCode === 13) {\n    event.preventDefault();\n    var target = event.currentTarget;\n    var text = target.value;\n    var ul = target.parentNode.nextSibling;\n    var reactReply = target.parentNode.parentNode.previousSibling.previousSibling.children[1].children[1];\n    var homeContentId = target.parentNode.parentNode.parentNode.id;\n    upComment(homeContentId, text, ul, reactReply);\n    target.value = \"\";\n  }\n};\n\nvar handleRelpy = function handleRelpy(event) {\n  event.preventDefault();\n  var target = event.currentTarget;\n  var contentComments = target.parentNode.nextSibling;\n  contentComments.style.display = \"flex\";\n};\n\nvar init = function init() {\n  var actionList = Array.from(actionLike);\n  var videoList = Array.from(video);\n  var commentList = Array.from(comment);\n  var replyList = Array.from(reply);\n  actionList.forEach(function (a) {\n    return a.addEventListener(\"click\", handleReactLike);\n  });\n  videoList.forEach(function (v) {\n    return v.addEventListener(\"play\", handleView);\n  });\n  commentList.forEach(function (c) {\n    return c.addEventListener(\"keyup\", handleComment);\n  });\n  replyList.forEach(function (r) {\n    return r.addEventListener(\"click\", handleRelpy);\n  });\n};\n\nif (actionLike) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/contentReact.js?");

/***/ }),

/***/ "./assets/js/joinRoom.js":
/*!*******************************!*\
  !*** ./assets/js/joinRoom.js ***!
  \*******************************/
/*! no exports provided */
...
eval("var plusFriend = document.getElementsByClassName(\"jsPlusFriend\");\n\nvar upFriend = function upFriend(id) {\n  fetch(\"/api/\".concat(id, \"/plusFriend\"), {\n    method: \"POST\",\n    headers: {\n      \"Content-Type\": \"application/json\"\n    },\n    body: JSON.stringify({\n      id: id\n    })\n  }).then(function (res) {\n    console.log(res);\n  })[\"catch\"](function (error) {\n    console.log(error);\n  });\n};\n\nvar handlePlus = function handlePlus(event) {\n  event.preventDefault();\n  event.stopPropagation();\n  var friend = event.path[4].id;\n  upFriend(friend);\n};\n\nvar init = function init() {\n  var plusList = Array.from(plusFriend);\n  plusList.forEach(function (p) {\n    return p.addEventListener(\"click\", handlePlus);\n  });\n};\n\nif (plusFriend) {\n  init();\n}\n\n//# sourceURL=webpack:///./assets/js/plusFriend.js?");
